...
from model.Model.SPPE.src.utils.img import flip, shuffleLR
from model.Model.SPPE.src.models.FastPose import FastPose
...
class InferenNet(nn.Module):
    def __init__(self, dataset, weights_file='./Model/Models/sppe/fast_res101_320x256.pth'):
        super().__init__()
...
class InferenNet_fast(nn.Module):
    def __init__(self, weights_file='./Model/Models/sppe/fast_res101_320x256.pth'):
        super().__init__()
...
class InferenNet_fastRes50(nn.Module):
    def __init__(self, weights_file=None,device='cuda'):
        super().__init__()

        self.pyranet = FastPose('resnet50', 17).cpu()#.cuda()
