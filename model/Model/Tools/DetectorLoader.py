...
import os
from model.Model.Detection.Models import Darknet
from model.Model.Detection.Utils import non_max_suppression, ResizePadding
...
class TinyYOLOv3_onecls(object):
    ...
    def __init__(self,
        ...
        if config_file is None:
            config_file = os.path.join(os.path.dirname(__file__) +'/../Models/yolo-tiny-onecls/yolov3-tiny-onecls.cfg')
        if weight_file is None:
            weight_file = os.path.join(os.path.dirname(__file__) +'/../Models/yolo-tiny-onecls/best-model.pth')
